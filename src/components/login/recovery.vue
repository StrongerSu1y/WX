  ...
  <div class="page-sign-recovery">
		<form id="form-recovery" class="form-recovery form-wxw">
			<div class="form-group">
				...
				<input id="login-mobile" type="text" class="form-control" placeholder="请输入您的注册手机号码" v-model="mobile">
				<div class="actions-group">
					<div class="btn-clear btn-action" @click="clearInput()"></div>
				</div>
			</div>
			<div class="form-group">
				<span class="tag-captcha tag-input"></span>
				<input id="login-captcha" type="text" class="form-control" placeholder="请输入您的验证码">
				<div class="actions-group">
			...
			<div class="form-group form-group-submit">
				<button class="btn-submit btn btn-block btn-primary btn-lg" type="button" @click="doSubmit()">
					提交
				</button>
			</div>
		</form>
